...
(() => {
    ...
    function t(t, i) {
        ...
        for (let i = 0; i < t.length; i++) {
            ...
            if (13 !== g || (l = t.charCodeAt(i + 1), l !== e)) if (92 === g) "" === p && (m = i), p += t.slice(i, i + 2), i += 1; else if (47 === g && 42 === t.charCodeAt(i + 1)) {
                let e = i;
                for (let e = i + 2; e < t.length; e++) if (l = t.charCodeAt(e), 92 === l) e += 1; else if (42 === l && 47 === t.charCodeAt(e + 1)) {
                    i = e + 1;
                    break
                }
                let r = t.slice(e, i + 1);
                ...
                if ((32 === g || g === e || 9 === g) && (l = t.charCodeAt(i + 1)) && (32 === l || l === e || 9 === l || 13 === l && (l = t.charCodeAt(i + 2)) && l == e)) continue;
                if (g === e) {
                    if (0 === p.length) continue;
                    l = p.charCodeAt(p.length - 1), 32 !== l && l !== e && 9 !== l && (p += " ")
                } else if (45 === g && 45 === t.charCodeAt(i + 1) && 0 === p.length) {
                    let e = "", r = i, c = -1;
                    for (let n = i + 2; n < t.length; n++) if (l = t.charCodeAt(n), 92 === l) n += 1; else if (39 === l || 34 === l) n = o(t, n, l); else if (47 === l && 42 === t.charCodeAt(n + 1)) {
                        for (let e = n + 2; e < t.length; e++) if (l = t.charCodeAt(e), 92 === l) e += 1; else if (42 === l && 47 === t.charCodeAt(e + 1)) {
                            n = e + 1;
                            break
                        }
                    } else if (-1 === c && 58 === l) c = p.length + n - r; else {
                        if (59 === l && 0 === e.length) {
                            p += t.slice(r, n), i = n;
                            break
                        }
                        if (40 === l) e += ")"; else if (91 === l) e += "]"; else if (123 === l) e += "}"; else {
                    ...
                    a && (u.src = [a, r, i], u.dst = [a, r, i]), d ? d.nodes.push(u) : s.push(u), p = ""
                } else if (59 === g && 64 === p.charCodeAt(0)) f = r(p), a && (f.src = [a, m, i], f.dst = [a, m, i]), d ? d.nodes.push(f) : s.push(f), p = "", f = null; else if (59 === g && ")" !== h[h.length - 1]) {
                    let e = n(p);
                    if (!e) throw 0 === p.length ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${p.trim()}\``);
                    a && (e.src = [a, m, i], e.dst = [a, m, i]), d ? d.nodes.push(e) : s.push(e), p = ""
                } else if (123 === g && ")" !== h[h.length - 1]) h += "}", f = y(p.trim()), a && (f.src = [a, m, i], f.dst = [a, m, i]), d && d.nodes.push(f), u.push(d), d = f, p = "", f = null; else if (125 === g && ")" !== h[h.length - 1]) {
                    if ("" === h) throw new Error("Missing opening {");
                    if (h = h.slice(0, -1), p.length > 0) if (64 === p.charCodeAt(0)) f = r(p), a && (f.src = [a, m, i], f.dst = [a, m, i]), d ? d.nodes.push(f) : s.push(f), p = "", f = null; else {
                        let e = p.indexOf(":");
                        if (d) {
                            let t = n(p, e);
    ...
    function o(t, r, n) {
        let o;
        for (let i = r + 1; i < t.length; i++) if (o = t.charCodeAt(i), 92 === o) i += 1; else {
            if (o === n) return i;
            if (59 === o && (t.charCodeAt(i + 1) === e || 13 === t.charCodeAt(i + 1) && t.charCodeAt(i + 2) === e)) throw new Error(`Unterminated string: ${t.slice(r, i + 1) + String.fromCharCode(n)}`);
            if (o === e || 13 === o && t.charCodeAt(i + 1) === e) throw new Error(`Unterminated string: ${t.slice(r, i) + String.fromCharCode(n)}`)
        }
        return r
    }
    ...
    function i(e) {
        ...
        for (; ++o < n;) t = r.charCodeAt(o), i += 0 !== t ? t >= 1 && t <= 31 || 127 === t || 0 === o && t >= 48 && t <= 57 || 1 === o && t >= 48 && t <= 57 && 45 === a ? "\\" + t.toString(16) + " " : t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 || t >= 65 && t <= 90 || t >= 97 && t <= 122 ? r.charAt(o) : "\\" + r.charAt(o) : "�";
        return i
    }
    ...
    var c = class {
        ...
        keysInNamespaces(e) {
            ...
            for (let r of e) {
                let e = `${r}-`;
                for (let n of this.values.keys()) n.startsWith(e) && -1 === n.indexOf("--", 2) && (s(n, r) || t.push(n.slice(e.length)))
            }
            return t
        }
        ...
        markUsedVariable(e) {
            let t = a(this.#e(e)), r = this.values.get(t);
            if (!r) return !1;
            let n = 16 & r.options;
    ...
    function h(e, t, r = null) {
        for (let n = 0; n < e.length; n++) {
            let o = e[n], i = !1, a = 0, l = t(o, {
                parent: r, replaceWith(t) {
                    i || (i = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), a = 0) : 1 === t.length ? (e[n] = t[0], a = 1) : (e.splice(n, 1, ...t), a = t.length) : e[n] = t)
                }
            }) ?? 0;
            if (i) 0 === l ? n-- : n += a - 1; else {
                if (2 === l) return 2;
        ...
        for (let a = 0; a < e.length; a++) {
            ...
            switch (l) {
                ...
                case 9: {
                    ...
                    let n = a, l = a + 1;
                    for (; l < e.length && (t = e.charCodeAt(l), 58 === t || 44 === t || 61 === t || 62 === t || 60 === t || 10 === t || 47 === t || 32 === t || 9 === t); l++) ;
                    a = l - 1;
                    let s = p(e.slice(n, l));
                ...
                case 34: {
                    let r = a;
                    for (let r = a + 1; r < e.length; r++) if (t = e.charCodeAt(r), 92 === t) r += 1; else if (t === l) {
                        a = r;
                        break
                    }
                    i += e.slice(r, a + 1);
    ...
    function C(e, t, r = [], n = {}) {
        for (let o = 0; o < e.length; o++) {
            ...
            r.push(i);
            let l = !1, s = 0, c = t(i, {
                parent: a, context: n, path: r, replaceWith(t) {
                    l || (l = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(o, 1), s = 0) : 1 === t.length ? (e[o] = t[0], s = 1) : (e.splice(o, 1, ...t), s = t.length) : (e[o] = t, s = 1))
                }
            }) ?? 0;
            if (r.pop(), l) 0 === c ? o-- : o += s - 1; else {
                if (2 === c) return 2;
                if (1 !== c && "nodes" in i) {
                    r.push(i);
    ...
    function j(e, t, r = [], n = {}) {
        for (let o = 0; o < e.length; o++) {
            let i = e[o], a = r[r.length - 1] ?? null;
            if ("rule" === i.kind || "at-rule" === i.kind) r.push(i), j(i.nodes, t, r, n), r.pop(); else if ("context" === i.kind) {
    ...
    function T(e, t, r = 3) {
        let n = [], o = new Set, i = new u((() => new Set)), a = new u((() => new Set)), l = new Set, s = new Set,
            c = [], d = [], f = new u((() => new Set));
        ...
        function p(e, u, h = {}, m = 0) {
            if ("declaration" === e.kind) {
                ...
                if (e.value.includes("var(")) if (h.theme && "-" === e.property[0] && "-" === e.property[1]) for (let t of v(e.value)) f.get(t).add(e.property); else t.trackUsedVariables(e.value);
                ...
                if (1 & r) {
                    let t = e.params, r = null, n = !1;
                    for (let t of e.nodes) "declaration" === t.kind && ("initial-value" === t.property ? r = t.value : "inherits" === t.property && (n = "true" === t.value));
                    let o = x(t, r ?? "initial");
                ...
                let t = {...e, nodes: []};
                for (let r of e.nodes) p(r, t.nodes, h, m + 1);
                "@keyframes" === e.name && h.theme && l.add(t), (t.nodes.length > 0 || "@layer" === t.name || "@charset" === t.name || "@custom-media" === t.name || "@namespace" === t.name || "@import" === t.name) && u.push(t)
        ...
        e:for (let [e, r] of i) for (let n of r) {
            if (E(n.property, t.theme, f)) {
                if (n.property.startsWith(t.theme.prefixKey("--animate-"))) for (let e of V(n.value)) s.add(e);
                continue
            }
            let r = e.indexOf(n);
        ...
        for (let e of l) if (!s.has(e.params)) {
            let t = n.indexOf(e);
            n.splice(t, 1)
        }
        if (w = w.concat(n), 2 & r) for (let [e, r] of a) for (let n of r) {
            let r = e.indexOf(n);
            ...
            if (h(o, ((e, {replaceWith: r}) => {
                ...
                if (h(e.nodes, ((e, {replaceWith: r}) => {
                    if ("word" == e.kind && "currentcolor" === e.value.toLowerCase()) return o = !0, void (i = !0);
                    let a = e, l = null, s = new Set;
                    do {
                        ...
                        if (s.add(r), i = !0, l = t.theme.resolveValue(null, [e.value]), !l) return void (n = !0);
            ...
            let a = {...n, value: m(o)}, l = y("@supports (color: color-mix(in lab, red, red))", [n]);
    ...
    function F(e) {
        ...
        let t = g(e);
        return U(t), e = function (e) {
            if (!N.some((t => e.includes(t)))) return e;
            let t = "", r = [], n = null, o = null;
            for (let i = 0; i < e.length; i++) {
                let a = e.charCodeAt(i);
                if (a >= 48 && a <= 57 || null !== n && (37 === a || a >= 97 && a <= 122 || a >= 65 && a <= 90) ? n = i : (o = n, n = null), 40 !== a) if (41 === a) t += e[i], r.shift(); else {
                    if (44 === a && r[0]) {
                        t += ", ";
                        continue
                    }
                    if (32 === a && r[0] && 32 === t.charCodeAt(t.length - 1)) continue;
                    if (43 !== a && 42 !== a && 47 !== a && 45 !== a || !r[0]) t += e[i]; else {
                        let r = t.trimEnd(), n = r.charCodeAt(r.length - 1), a = r.charCodeAt(r.length - 2),
                            l = e.charCodeAt(i + 1);
        ...
        for (let t of e) switch (t.kind) {
            case"function":
                ...
                if ("var" === t.value || t.value.endsWith("_var") || "theme" === t.value || t.value.endsWith("_theme")) {
                    t.value = W(t.value);
                    for (let e = 0; e < t.nodes.length; e++) 0 != e || "word" !== t.nodes[e].kind ? U([t.nodes[e]]) : t.nodes[e].value = W(t.nodes[e].value, !0);
                    break
                }
    ...
    function L(e, t) {
        let r = 0, n = [], o = 0, i = e.length, a = t.charCodeAt(0);
        for (let t = 0; t < i; t++) {
    ...
    function I(e) {
        if ("[" === e[0] && "]" === e[e.length - 1]) {
            let t = F(e.slice(1, -1));
            return M(t) && 0 !== t.length && 0 !== t.trim().length ? {kind: "arbitrary", value: t} : null
        }
        return "(" === e[0] && ")" === e[e.length - 1] ? "-" === (e = e.slice(1, -1))[0] && "-" === e[1] && M(e) ? {
            kind: "arbitrary",
            value: F(e = `var(${e})`)
        } : null : {kind: "named", value: e}
    }
    ...
    function P(e) {
        if (null === e) return "";
        let t = X(e.value), r = t ? e.value.slice(4, -1) : e.value, [n, o] = t ? ["(", ")"] : ["[", "]"];
        return "arbitrary" === e.kind ? `/${n}${Z(r)}${o}` : "named" === e.kind ? `/${e.value}` : ""
    }

    function q(e) {
        if ("static" === e.kind) return e.root;
        if ("arbitrary" === e.kind) return `[${Z(function (e) {
            return Y.get(e)
        }(e.selector))}]`;
        let t = "";
        if ("functional" === e.kind) {
            t += e.root;
            let r = "@" !== e.root;
            if (e.value) if ("arbitrary" === e.value.kind) {
                let n = X(e.value.value),
                    o = n ? e.value.value.slice(4, -1) : e.value.value, [i, a] = n ? ["(", ")"] : ["[", "]"];
                t += `${r ? "-" : ""}${i}${Z(o)}${a}`
            } else "named" === e.value.kind && (t += `${r ? "-" : ""}${e.value.value}`)
        }
        return "compound" === e.kind && (t += e.root, t += "-", t += q(e.variant)), ("functional" === e.kind || "compound" === e.kind) && (t += P(e.modifier)), t
    }
    ...
    var H = new u((e => {
        ...
        return h(t, ((e, {parent: n}) => {
            ...
            if ("word" !== e.kind || "+" !== e.value && "-" !== e.value && "*" !== e.value && "/" !== e.value) "separator" === e.kind && "/" === e.value.trim() ? e.value = "/" : "separator" === e.kind && e.value.length > 0 && "" === e.value.trim() ? (o[0] === e || o[o.length - 1] === e) && r.add(e) : "separator" === e.kind && "," === e.value.trim() && (e.value = ","); else {
                let t = o.indexOf(e) ?? -1;
                if (-1 === t) return;
                let n = o[t - 1];
    ...
    var oe = {
        color: function (e) {
        ...
        }, length: ve, percentage: he, ratio: function (e) {
            return me.test(e) || O(e)
        }, number: fe, integer: be, url: le, position: function (e) {
            let t = 0;
            for (let r of L(e, " ")) if ("center" !== r && "top" !== r && "right" !== r && "bottom" !== r && "left" !== r) {
                if (!r.startsWith("var(")) {
                    if (ve(r) || he(r)) {
                        t += 1;
                        continue
            ...
            let t = 0;
            for (let r of L(e, ",")) if (!r.startsWith("var(")) {
                if (le(r)) {
                    t += 1;
                    continue
                }
    ...
    var se = /^(?:element|image|cross-fade|image-set)\(/, ce = /^(repeating-)?(conic|linear|radial)-gradient\(/;
    var ue = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/, de = new RegExp(`^${ue.source}$`);
    ...
    var ze = new Set(["inset", "inherit", "initial", "revert", "unset"]), Ce = /^-?(\d+|\.\d+)(.*?)$/g;

    function je(e, t) {
        return L(e, ",").map((e => {
            let r = L(e = e.trim(), " ").filter((e => "" !== e.trim())), n = null, o = null, i = null;
            for (let e of r) ze.has(e) || (Ce.test(e) ? (null === o ? o = e : null === i && (i = e), Ce.lastIndex = 0) : null === n && (n = e));
    ...
    var Te = /^-?[a-z][a-zA-Z0-9/%._-]*$/, Se = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/,
    ...
    function _e(e, t, r) {
        for (let n of t.nodes) {
            if ("named" === e.kind && "word" === n.kind && ("'" === n.value[0] || '"' === n.value[0]) && n.value[n.value.length - 1] === n.value[0] && n.value.slice(1, -1) === e.value) return {nodes: g(e.value)};
    ...
    function Me(e, t, r, n, o = "") {
        let i = !1,
            a = je(t, (e => null == r ? n(e) : e.startsWith("current") ? n(Ne(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (i = !0), n(Oe(e, r)))));
    ...
    function Be(e, t, r, n, o = "") {
        let i = !1,
            a = L(t, ",").map((e => je(e, (e => null == r ? n(e) : e.startsWith("current") ? n(Ne(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (i = !0), n(Oe(e, r))))))).map((e => `drop-shadow(${e})`)).join(" ");
    ...
    var Le = {
        "--alpha": function (e, t, r, ...n) {
            ...
            if (!o || !i) throw new Error(`The --alpha(…) function requires a color and an alpha value, e.g.: \`--alpha(${o || "var(--my-color)"} / ${i || "50%"})\``);
            if (n.length > 0) throw new Error(`The --alpha(…) function only accepts one argument, e.g.: \`--alpha(${o || "var(--my-color)"} / ${i || "50%"})\``);
            return Ne(o, i)
            ...
            if (!o) throw new Error(`Could not resolve value for theme function: \`theme(${r})\`. Consider checking if the path is correct or provide a fallback value to silence this error.`);
            return o
        }
    };
    ...
    function Re(e, t) {
        let r = 0;
        return C(e, (e => {
            if ("declaration" === e.kind && e.value && Ie.test(e.value)) return r |= 8, void (e.value = Pe(e.value, e, t));
            "at-rule" === e.kind && ("@media" === e.name || "@custom-media" === e.name || "@container" === e.name || "@supports" === e.name) && Ie.test(e.params) && (r |= 8, e.params = Pe(e.params, e, t))
        })), r
    }
    ...
    function Ze(e) {
        ...
        for (let r of e.utilities.keys("functional")) {
            ...
            for (let e of n) for (let n of e.values) {
                let o = null !== n && He.test(n), i = null === n ? r : `${r}-${n}`, a = t.get(i);
                if (a.utility = r, a.fraction ||= o, a.modifiers.push(...e.modifiers), e.supportsNegative) {
                    let n = t.get(`-${i}`);
        ...
        return r.sort(((e, t) => qe(e.name, t.name))), function (e) {
            let t = [], r = null, n = new Map, o = new u((() => []));
            for (let i of e) {
                let {utility: e, fraction: a} = i;
                r || (r = {utility: e, items: []}, n.set(e, r)), e !== r.utility && (t.push(r), r = {
                    utility: e,
                    items: []
                }, n.set(e, r)), a ? o.get(e).push(i) : r.items.push(i)
            }
    ...
    var Ye = /^@?[a-zA-Z0-9_-]*$/, Ge = class {
        ...
        compoundsWith(e, t) {
            let r = this.variants.get(e),
                n = "string" == typeof t ? this.variants.get(t) : "arbitrary" === t.kind ? {compounds: Je([t.selector])} : this.variants.get(t.root);
    ...
    function Qe(e, t) {
        C(e, ((e, {replaceWith: r}) => {
            if ("at-rule" === e.kind && "@slot" === e.name) r(t); else if ("at-rule" === e.kind && ("@keyframes" === e.name || "@property" === e.name)) return Object.assign(e, z([b(e.name, e.params, e.nodes)])), 1
        }))
    }
        ...
        let t = function (e) {
            ...
            function r(r, n) {
                ...
                t.suggest(r, (() => {
                    ...
                    for (let t of n()) {
                        ...
                        t.supportsFractions && r.push(...i), t.hasDefaultValue && r.unshift(null), e.push({
            ...
            function i(n, o) {
                t.functional(n, (t => {
                    if (!t.value) return;
                    let r = null;
                    return "arbitrary" === t.value.kind ? (r = t.value.value, r = Fe(r, t.modifier, e)) : r = We(t, e, o.themeKeys), null !== r ? o.handle(r) : void 0
                })), r(n, (() => [{
            ...
            function a(n, i, a, {supportsNegative: l = !1, supportsFractions: s = !1} = {}) {
                l && t.static(`-${n}-px`, (() => a("-1px"))), t.static(`${n}-px`, (() => a("1px"))), o(n, {
                    themeKeys: i,
                    supportsFractions: s,
                    supportsNegative: l,
                    defaultValue: null,
            ...
            for (let [e, t] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) n(`${e}-auto`, [[t, "auto"]]), n(`${e}-full`, [[t, "100%"]]), n(`-${e}-full`, [[t, "-100%"]]), a(e, ["--inset", "--spacing"], (e => [x(t, e)]), {
                supportsNegative: !0,
                supportsFractions: !0
            });
            ...
            }])), n("order-first", [["order", "-9999"]]), n("order-last", [["order", "9999"]]), o("order", {
                supportsNegative: !0,
                handleBareValue: ({value: e}) => be(e) ? e : null,
                themeKeys: ["--order"],
                handle: e => [x("order", e)]
            ...
            for (let [e, t] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) n(`${e}-auto`, [[t, "auto"]]), a(e, ["--margin", "--spacing"], (e => [x(t, e)]), {supportsNegative: !0});
            ...
            for (let [e, t] of [["full", "100%"], ["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"], ["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]]) n(`size-${e}`, [["--tw-sort", "size"], ["width", t], ["height", t]]), n(`w-${e}`, [["width", t]]), n(`h-${e}`, [["height", t]]), n(`min-w-${e}`, [["min-width", t]]), n(`min-h-${e}`, [["min-height", t]]), n(`max-w-${e}`, [["max-width", t]]), n(`max-h-${e}`, [["max-height", t]]);
            n("size-auto", [["--tw-sort", "size"], ["width", "auto"], ["height", "auto"]]), n("w-auto", [["width", "auto"]]), n("h-auto", [["height", "auto"]]), n("min-w-auto", [["min-width", "auto"]]), n("min-h-auto", [["min-height", "auto"]]), n("h-lh", [["height", "1lh"]]), n("min-h-lh", [["min-height", "1lh"]]), n("max-h-lh", [["max-height", "1lh"]]), n("w-screen", [["width", "100vw"]]), n("min-w-screen", [["min-width", "100vw"]]), n("max-w-screen", [["max-width", "100vw"]]), n("h-screen", [["height", "100vh"]]), n("min-h-screen", [["min-height", "100vh"]]), n("max-h-screen", [["max-height", "100vh"]]), n("max-w-none", [["max-width", "none"]]), n("max-h-none", [["max-height", "none"]]), a("size", ["--size", "--spacing"], (e => [x("--tw-sort", "size"), x("width", e), x("height", e)]), {supportsFractions: !0});
            for (let [e, t, r] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) a(e, t, (e => [x(r, e)]), {supportsFractions: !0});
            t.static("container", (() => {
                ...
                if (e.value) {
                    if ("arbitrary" === e.value.kind) return e.modifier ? void 0 : [x("flex", e.value.value)];
                    if (e.value.fraction) {
                ...
                valueThemeKeys: [],
                hasDefaultValue: !0
            }])), n("basis-auto", [["flex-basis", "auto"]]), n("basis-full", [["flex-basis", "100%"]]), a("basis", ["--flex-basis", "--spacing", "--container"], (e => [x("flex-basis", e)]), {supportsFractions: !0}), n("table-auto", [["table-layout", "auto"]]), n("table-fixed", [["table-layout", "fixed"]]), n("caption-top", [["caption-side", "top"]]), n("caption-bottom", [["caption-side", "bottom"]]), n("border-collapse", [["border-collapse", "collapse"]]), n("border-separate", [["border-collapse", "separate"]]);
            ...
            n("translate-none", [["translate", "none"]]), n("-translate-full", [s, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), n("translate-full", [s, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a("translate", ["--translate", "--spacing"], (e => [s(), x("--tw-translate-x", e), x("--tw-translate-y", e), x("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
                supportsNegative: !0,
                supportsFractions: !0
            });
            for (let e of ["x", "y"]) n(`-translate-${e}-full`, [s, [`--tw-translate-${e}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), n(`translate-${e}-full`, [s, [`--tw-translate-${e}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a(`translate-${e}`, ["--translate", "--spacing"], (t => [s(), x(`--tw-translate-${e}`, t), x("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
                supportsNegative: !0,
                supportsFractions: !0
            });
            a("translate-z", ["--translate", "--spacing"], (e => [s(), x("--tw-translate-z", e), x("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")]), {supportsNegative: !0}), n("translate-3d", [s, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
            ...
            function u({negative: t}) {
                return r => {
                    ...
                    let n;
                    return "arbitrary" === r.value.kind ? (n = r.value.value, n = t ? `calc(${n} * -1)` : n, [x("scale", n)]) : (n = e.resolve(r.value.value, ["--scale"]), !n && be(r.value.value) && (n = `${r.value.value}%`), n ? (n = t ? `calc(${n} * -1)` : n, [c(), x("--tw-scale-x", n), x("--tw-scale-y", n), x("--tw-scale-z", n), x("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
                }
            }
            ...
            function d({negative: t}) {
                return r => {
                    ...
                    } else if (n = e.resolve(r.value.value, ["--rotate"]), !n && be(r.value.value) && (n = `${r.value.value}deg`), !n) return;
            ...
            }]));
            {
                ...
                o("skew", {
                    ...
                    let r = null;
                    return t.value ? "arbitrary" === t.value.kind && (r = t.value.value) : r = e, null !== r ? [i(), x("transform", r)] : void 0
            ...
            for (let e of ["x", "y", "both"]) n(`snap-${e}`, [p, ["scroll-snap-type", `${e} var(--tw-scroll-snap-strictness)`]]);
            ...
            n("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), n("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), n("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), n("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), n("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), n("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
            {
                ...
                i("border", {
                    ...
                    valueThemeKeys: ["--divide-width", "--border-width"],
                    hasDefaultValue: !0
                }])), n("divide-x-reverse", [() => z([Ve("--tw-divide-x-reverse", "0")]), () => k(":where(& > :not(:last-child))", [x("--tw-divide-x-reverse", "1")])]), n("divide-y-reverse", [() => z([Ve("--tw-divide-y-reverse", "0")]), () => k(":where(& > :not(:last-child))", [x("--tw-divide-y-reverse", "1")])]);
                for (let e of ["solid", "dashed", "dotted", "double", "none"]) n(`divide-${e}`, [() => k(":where(& > :not(:last-child))", [x("--tw-sort", "divide-style"), x("--tw-border-style", e), x("border-style", e)])])
            }
            ...
            }), n("bg-repeat", [["background-repeat", "repeat"]]), n("bg-no-repeat", [["background-repeat", "no-repeat"]]), n("bg-repeat-x", [["background-repeat", "repeat-x"]]), n("bg-repeat-y", [["background-repeat", "repeat-y"]]), n("bg-repeat-round", [["background-repeat", "round"]]), n("bg-repeat-space", [["background-repeat", "space"]]), n("bg-none", [["background-image", "none"]]);
            {
                let e = function (e) {
                        ...
                        return r => {
                            ...
                            if ("arbitrary" === r.value.kind) {
                                if (r.modifier) return;
                                let e = r.value.value;
                                return "angle" === (r.value.dataType ?? ie(e, ["angle"])) ? (e = t ? `calc(${e} * -1)` : `${e}`, [x("--tw-gradient-position", e), x("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]) : t ? void 0 : [x("--tw-gradient-position", e), x("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]
                            }
                            let n = r.value.value;
                            if (!t && a.has(n)) n = a.get(n); else {
                                if (!be(n)) return;
                        ...
                        return r => {
                            ...
                            let n = e(r.modifier);
                            if (!r.value) return [x("--tw-gradient-position", n), x("background-image", "conic-gradient(var(--tw-gradient-stops))")];
                            let o = r.value.value;
                            return be(o) ? (o = t ? `calc(${o}deg * -1)` : `${o}deg`, [x("--tw-gradient-position", `from ${o} ${n}`), x("background-image", "conic-gradient(var(--tw-gradient-stops))")]) : void 0
                        }
                ...
                t.functional("-bg-linear", n({negative: !0})), t.functional("bg-linear", n({negative: !1})), r("bg-linear", (() => [{
                    ...
                    if (!t.value) return [x("--tw-gradient-position", e(t.modifier)), x("background-image", "radial-gradient(var(--tw-gradient-stops))")];
                    if ("arbitrary" === t.value.kind) {
                        if (t.modifier) return;
                        let e = t.value.value;
                ...
                if (t.value) {
                    if ("arbitrary" === t.value.kind) {
                        ...
                        switch (t.value.dataType ?? ie(r, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
                            ...
                            default:
                                return r = Fe(r, t.modifier, e), null === r ? void 0 : [x("background-color", r)]
                        }
                    }
                    {
                ...
                t.functional(n, (t => {
                    if (t.value) {
                        ...
                        }
                        {
                            ...
                            if ("%" === t.value.value[t.value.value.length - 1] && be(t.value.value.slice(0, -1))) return o.position(t.value.value)
                        }
                    }
                })), r(n, (() => [{
                    values: ["current", "inherit", "transparent"],
            ...
            }), n("mask-none", [["mask-image", "none"]]), t.functional("mask", (e => {
            ...
            function v(n, o) {
                t.functional(n, (t => {
                    ...
                    values: Array.from({length: 21}, ((e, t) => 5 * t + "%")),
                    valueThemeKeys: ["--gradient-color-stop-positions"]
                }])), r(n, (() => [{values: Array.from({length: 21}, ((e, t) => 5 * t + "%"))}, {values: e.get(["--spacing"]) ? Ke : []}, {
                    values: ["current", "inherit", "transparent"],
                    valueThemeKeys: ["--background-color", "--color"],
                    modifiers: Array.from({length: 21}, ((e, t) => "" + 5 * t))
                }]))
            ...
            $("mask-x-from", "from", {top: !1, right: !0, bottom: !1, left: !0}), $("mask-x-to", "to", {
                top: !1,
                right: !0,
                bottom: !1,
                left: !0
            }), $("mask-y-from", "from", {top: !0, right: !1, bottom: !0, left: !1}), $("mask-y-to", "to", {
                top: !0,
                right: !1,
                bottom: !0,
                left: !1
            }), $("mask-t-from", "from", {top: !0, right: !1, bottom: !1, left: !1}), $("mask-t-to", "to", {
                top: !0,
                right: !1,
                bottom: !1,
                left: !1
            }), $("mask-r-from", "from", {top: !1, right: !0, bottom: !1, left: !1}), $("mask-r-to", "to", {
                top: !1,
                right: !0,
                bottom: !1,
                left: !1
            }), $("mask-b-from", "from", {top: !1, right: !1, bottom: !0, left: !1}), $("mask-b-to", "to", {
                top: !1,
                right: !1,
                bottom: !0,
                left: !1
            }), $("mask-l-from", "from", {top: !1, right: !1, bottom: !1, left: !0}), $("mask-l-to", "to", {
                top: !1,
                right: !1,
                bottom: !1,
                left: !0
                ...
                if (t.value) {
                    if ("arbitrary" === t.value.kind) {
                        ...
                        switch (t.value.dataType ?? ie(r, ["color", "number", "length", "percentage"])) {
                            ...
                            default:
                                return r = Fe(t.value.value, t.modifier, e), null === r ? void 0 : [x("stroke", r)]
                        }
                    }
                    {
            ...
            for (let [e, t] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) a(e, ["--padding", "--spacing"], (e => [x(t, e)]));
            n("text-left", [["text-align", "left"]]), n("text-center", [["text-align", "center"]]), n("text-right", [["text-align", "right"]]), n("text-justify", [["text-align", "justify"]]), n("text-start", [["text-align", "start"]]), n("text-end", [["text-align", "end"]]), a("indent", ["--text-indent", "--spacing"], (e => [x("text-indent", e)]), {supportsNegative: !0}), n("align-baseline", [["vertical-align", "baseline"]]), n("align-top", [["vertical-align", "top"]]), n("align-middle", [["vertical-align", "middle"]]), n("align-bottom", [["vertical-align", "bottom"]]), n("align-text-top", [["vertical-align", "text-top"]]), n("align-text-bottom", [["vertical-align", "text-bottom"]]), n("align-sub", [["vertical-align", "sub"]]), n("align-super", [["vertical-align", "super"]]), o("align", {
                themeKeys: [],
                ...
                if (t.value && !t.modifier) {
                    ...
                    }
                    {
                        ...
                        if (r) return [z([Ve("--tw-font-weight")]), x("--tw-font-weight", r), x("font-weight", r)]
                    }
                }
                ...
                if (t.value) {
                    if ("arbitrary" === t.value.kind) {
                        ...
                        switch (t.value.dataType ?? ie(r, ["color", "length", "percentage"])) {
                            ...
                            default:
                                return r = Fe(r, t.modifier, e), null === r ? void 0 : [x("text-decoration-color", r)]
                        }
                    }
                    {
                        let r = e.resolve(t.value.value, ["--text-decoration-thickness"]);
                        if (r) return t.modifier ? void 0 : [x("text-decoration-thickness", r)];
                        if (be(t.value.value)) return t.modifier ? void 0 : [x("text-decoration-thickness", `${t.value.value}px`)]
                    }
                    {
            ...
            });
            {
                ...
                t.functional("filter", (e => {
                    ...
                    if (!e.modifier) {
                        if (null === e.value) return [s(), x("-webkit-backdrop-filter", a), x("backdrop-filter", a)];
                        if ("arbitrary" === e.value.kind) return [x("-webkit-backdrop-filter", e.value.value), x("backdrop-filter", e.value.value)];
                        if ("none" === e.value.value) return [x("-webkit-backdrop-filter", "none"), x("backdrop-filter", "none")]
                    }
                })), o("blur", {
                    themeKeys: ["--blur"],
                    handle: e => [l(), x("--tw-blur", `blur(${e})`), x("filter", i)]
                }), n("blur-none", [l, ["--tw-blur", " "], ["filter", i]]), o("backdrop-blur", {
                    themeKeys: ["--backdrop-blur", "--blur"],
                    handle: e => [s(), x("--tw-backdrop-blur", `blur(${e})`), x("-webkit-backdrop-filter", a), x("backdrop-filter", a)]
                }), n("backdrop-blur-none", [s, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", a], ["backdrop-filter", a]]), o("brightness", {
                    ...
                    hasDefaultValue: !0
                }])), n("drop-shadow-none", [l, ["--tw-drop-shadow", " "], ["filter", i]]), t.functional("drop-shadow", (t => {
                    let r;
                    if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : be(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                        let t = e.get(["--drop-shadow"]), n = e.resolve(null, ["--drop-shadow"]);
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? ie(n, ["color"])) ? (n = Fe(n, t.modifier, e), null === n ? void 0 : [l(), x("--tw-drop-shadow-color", Ne(n, "var(--tw-drop-shadow-alpha)")), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]) : t.modifier && !r ? void 0 : [l(), x("--tw-drop-shadow-alpha", r), ...Be("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), x("filter", i)]
                    }
                    {
                        let n = e.get([`--drop-shadow-${t.value.value}`]),
                            o = e.resolve(t.value.value, ["--drop-shadow"]);
                        if (n && o) return t.modifier && !r ? void 0 : r ? [l(), x("--tw-drop-shadow-alpha", r), ...Be("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), x("filter", i)] : [l(), x("--tw-drop-shadow-alpha", r), ...Be("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), x("--tw-drop-shadow", L(o, ",").map((e => `drop-shadow(${e})`)).join(" ")), x("filter", i)]
                    }
                    {
                        let r = We(t, e, ["--drop-shadow-color", "--color"]);
                        if (r) return "inherit" === r ? [l(), x("--tw-drop-shadow-color", "inherit"), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)")] : [l(), x("--tw-drop-shadow-color", Ne(r, "var(--tw-drop-shadow-alpha)")), x("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]
                    }
                })), r("drop-shadow", (() => [{
                    values: ["current", "inherit", "transparent"],
                    valueThemeKeys: ["--drop-shadow-color", "--color"],
                    modifiers: Array.from({length: 21}, ((e, t) => "" + 5 * t))
                }, {valueThemeKeys: ["--drop-shadow"]}])), o("backdrop-opacity", {
            ...
            }
            {
                ...
                });
                {
                    ...
                    n("duration-initial", [r, ["--tw-duration", "initial"]]), t.functional("duration", (t => {
                        ...
                        let n = null;
                        return "arbitrary" === t.value.kind ? n = t.value.value : (n = e.resolve(t.value.fraction ?? t.value.value, ["--transition-duration"]), null === n && be(t.value.value) && (n = `${t.value.value}ms`)), null !== n ? [r(), x("--tw-duration", n), x("transition-duration", n)] : void 0
                    }))
                }
                r("delay", (() => [{
            ...
            n("forced-color-adjust-none", [["forced-color-adjust", "none"]]), n("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), n("leading-none", [() => z([Ve("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), a("leading", ["--leading", "--spacing"], (e => [z([Ve("--tw-leading")]), x("--tw-leading", e), x("line-height", e)])), o("tracking", {
                supportsNegative: !0,
                themeKeys: ["--tracking"],
            ...
            }
            {
                ...
                t.static("outline-hidden", (() => [x("--tw-outline-style", "none"), x("outline-style", "none"), b("@media", "(forced-colors: active)", [x("outline", "2px solid transparent"), x("outline-offset", "2px")])])), n("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), n("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), n("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), n("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), n("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (t => {
                    if (null === t.value) {
                        if (t.modifier) return;
                    ...
                    if ("arbitrary" === t.value.kind) {
                        ...
                        switch (t.value.dataType ?? ie(r, ["color", "length", "number", "percentage"])) {
                            ...
                            default:
                                return r = Fe(r, t.modifier, e), null === r ? void 0 : [x("outline-color", r)]
                        }
                    }
                    {
                    ...
                    }
                    {
                        ...
                        if (r) return [i(), x("outline-style", "var(--tw-outline-style)"), x("outline-width", r)];
                        if (be(t.value.value)) return [i(), x("outline-style", "var(--tw-outline-style)"), x("outline-width", `${t.value.value}px`)]
                    }
                })), r("outline", (() => [{
                    values: ["current", "inherit", "transparent"],
                        ...
                        switch (t.value.dataType ?? ie(r, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
                            ...
                            case"relative-size":
                                if (t.modifier) {
                                    ...
                                    return !n && "none" === t.modifier.value && (n = "1"), n ? [x("font-size", r), x("line-height", n)] : null
                                }
            ...
            n("text-shadow-initial", [T, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (t => {
                let r;
                if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : be(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                ...
                if ("arbitrary" === t.value.kind) {
                    let n = t.value.value;
                    return "color" === (t.value.dataType ?? ie(n, ["color"])) ? (n = Fe(n, t.modifier, e), null === n ? void 0 : [T(), x("--tw-text-shadow-color", Ne(n, "var(--tw-text-shadow-alpha)"))]) : [T(), x("--tw-text-shadow-alpha", r), ...Me("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
                }
                ...
                }
                {
                    ...
                    if (n) return [T(), x("--tw-text-shadow-alpha", r), ...Me("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
                }
                {
                    let r = We(t, e, ["--text-shadow-color", "--color"]);
                    if (r) return [T(), x("--tw-text-shadow-color", Ne(r, "var(--tw-text-shadow-alpha)"))]
                }
            })), r("text-shadow", (() => [{
                values: ["current", "inherit", "transparent"],
            ...
            }]));
            {
                ...
                n("shadow-initial", [s, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (t => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? ie(n, ["color"])) ? (n = Fe(n, t.modifier, e), null === n ? void 0 : [s(), x("--tw-shadow-color", Ne(n, "var(--tw-shadow-alpha)"))]) : [s(), x("--tw-shadow-alpha", r), ...Me("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), x("box-shadow", a)]
                    }
                    switch (t.value.value) {
                        case"none":
                    ...
                    }
                    {
                        ...
                        if (n) return [s(), x("--tw-shadow-alpha", r), ...Me("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), x("box-shadow", a)]
                    }
                    {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? ie(n, ["color"])) ? (n = Fe(n, t.modifier, e), null === n ? void 0 : [s(), x("--tw-inset-shadow-color", Ne(n, "var(--tw-inset-shadow-alpha)"))]) : [s(), x("--tw-inset-shadow-alpha", r), ...Me("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`), "inset "), x("box-shadow", a)]
                    }
                    switch (t.value.value) {
                        case"none":
                    ...
                    }
                    {
                        ...
                        if (n) return [s(), x("--tw-inset-shadow-alpha", r), ...Me("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`)), x("box-shadow", a)]
                    }
                    {
                        let r = We(t, e, ["--box-shadow-color", "--color"]);
                        if (r) return [s(), x("--tw-inset-shadow-color", Ne(r, "var(--tw-inset-shadow-alpha)"))]
                    }
                })), r("inset-shadow", (() => [{
                    values: ["current", "inherit", "transparent"],
                    valueThemeKeys: ["--box-shadow-color", "--color"],
                ...
                t.functional("ring", (t => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let r = t.value.value;
                        return "length" === (t.value.dataType ?? ie(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), x("--tw-ring-shadow", o(r)), x("box-shadow", a)] : (r = Fe(r, t.modifier, e), null === r ? void 0 : [x("--tw-ring-color", r)])
                    }
                    {
                    ...
                    }
                    {
                        ...
                        if (null === r && be(t.value.value) && (r = `${t.value.value}px`), r) return [s(), x("--tw-ring-shadow", o(r)), x("box-shadow", a)]
                    }
                })), r("ring", (() => [{
                    values: ["current", "inherit", "transparent"],
                    ...
                    if (!t.value) return t.modifier ? void 0 : [s(), x("--tw-inset-ring-shadow", i("1px")), x("box-shadow", a)];
                    if ("arbitrary" === t.value.kind) {
                        let r = t.value.value;
                        return "length" === (t.value.dataType ?? ie(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), x("--tw-inset-ring-shadow", i(r)), x("box-shadow", a)] : (r = Fe(r, t.modifier, e), null === r ? void 0 : [x("--tw-inset-ring-color", r)])
                    }
                    {
                        let r = We(t, e, ["--ring-color", "--color"]);
                    ...
                    }
                    {
                        if (t.modifier) return;
                        let r = e.resolve(t.value.value, ["--ring-width"]);
                        if (null === r && be(t.value.value) && (r = `${t.value.value}px`), r) return [s(), x("--tw-inset-ring-shadow", i(r)), x("box-shadow", a)]
                    }
                })), r("inset-ring", (() => [{
                    values: ["current", "inherit", "transparent"],
                    valueThemeKeys: ["--ring-color", "--color"],
                ...
                t.functional("ring-offset", (t => {
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            return "length" === (t.value.dataType ?? ie(r, ["color", "length"])) ? t.modifier ? void 0 : [x("--tw-ring-offset-width", r), x("--tw-ring-offset-shadow", u)] : (r = Fe(r, t.modifier, e), null === r ? void 0 : [x("--tw-ring-offset-color", r)])
                        }
                        {
                            let r = e.resolve(t.value.value, ["--ring-offset-width"]);
                            if (r) return t.modifier ? void 0 : [x("--tw-ring-offset-width", r), x("--tw-ring-offset-shadow", u)];
                            if (be(t.value.value)) return t.modifier ? void 0 : [x("--tw-ring-offset-width", `${t.value.value}px`), x("--tw-ring-offset-shadow", u)]
                        }
                        {
            ...
            return r("ring-offset", (() => [{
                ...
                let t = null;
                if (null === e.value ? t = "inline-size" : "arbitrary" === e.value.kind ? t = e.value.value : "named" === e.value.kind && "normal" === e.value.value && (t = "normal"), null !== t) return e.modifier ? [x("container-type", t), x("container-name", e.modifier.value)] : [x("container-type", t)]
            })), r("@container", (() => [{values: ["normal"], valueThemeKeys: [], hasDefaultValue: !0}])), t
        }(e), r = function (e) {
            let t = new Ge;

            function r(e, r, {compounds: n} = {}) {
                n = n ?? Je(r), t.static(e, (e => {
            ...
            t.compound("not", 3, ((e, t) => {
                ...
                return C([t], ((e, {path: t}) => {
                    ...
                    L(r, ",").length > 1 && (r = `:is(${r})`), e.selector = `&:is(${r} *)`, o = !0
                })), o ? void 0 : null
            ...
            })), t.suggest("peer", (() => Array.from(t.keys()).filter((e => t.compoundsWith("peer", e))))), r("first-letter", ["&::first-letter"]), r("first-line", ["&::first-line"]), r("marker", ["& *::marker", "&::marker", "& *::-webkit-details-marker", "&::-webkit-details-marker"]), r("selection", ["& *::selection", "&::selection"]), r("file", ["&::file-selector-button"]), r("placeholder", ["&::placeholder"]), r("backdrop", ["&::backdrop"]), r("details-content", ["&::details-content"]);
            {
                let e = function () {
            ...
            r("first", ["&:first-child"]), r("last", ["&:last-child"]), r("only", ["&:only-child"]), r("odd", ["&:nth-child(odd)"]), r("even", ["&:nth-child(even)"]), r("first-of-type", ["&:first-of-type"]), r("last-of-type", ["&:last-of-type"]), r("only-of-type", ["&:only-of-type"]), r("visited", ["&:visited"]), r("target", ["&:target"]), r("open", ["&:is([open], :popover-open, :open)"]), r("default", ["&:default"]), r("checked", ["&:checked"]), r("indeterminate", ["&:indeterminate"]), r("placeholder-shown", ["&:placeholder-shown"]), r("autofill", ["&:autofill"]), r("optional", ["&:optional"]), r("required", ["&:required"]), r("valid", ["&:valid"]), r("invalid", ["&:invalid"]), r("user-valid", ["&:user-valid"]), r("user-invalid", ["&:user-invalid"]), r("in-range", ["&:in-range"]), r("out-of-range", ["&:out-of-range"]), r("read-only", ["&:read-only"]), r("empty", ["&:empty"]), r("focus-within", ["&:focus-within"]), t.static("hover", (e => {
                ...
                if (!t.value || t.modifier || "named" === t.value.kind && !be(t.value.value)) return null;
                ...
                } else r.includes(":") || (r = `${r}: var(--tw)`), ("(" !== r[0] || ")" !== r[r.length - 1]) && (r = `(${r})`), e.nodes = [b("@supports", r, e.nodes)]
            }), {compounds: 1}), r("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), r("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), r("contrast-more", ["@media (prefers-contrast: more)"]), r("contrast-less", ["@media (prefers-contrast: less)"]);
            {
                ...
                {
                    let n = e.namespace("--breakpoint"), o = new u((t => {
                        switch (t.kind) {
                            case"static":
                ...
                {
                    let n = e.namespace("--container"), o = new u((t => {
                        switch (t.kind) {
                            case"functional": {
            ...
            return null
        }(e, s))), o = new u((e => Array.from(function* (e, t) {
            let r = L(e, ":");
            if (t.theme.prefix) {
            ...
            if (null === l || null !== u) if ("[" !== a[0]) {
                if ("]" === a[a.length - 1]) {
                    ...
                    let r = a.slice(0, e);
                    if (!t.utilities.has(r, "functional")) return;
                    let n = a.slice(e + 2, -1), o = L(n, ":"), i = null;
                    if (2 === o.length && (i = o[0], n = o[1]), "-" !== n[0] || "-" !== n[1] || !M(n)) return;
                ...
                let n = a.slice(0, r), l = F(a.slice(r + 1));
                if (!M(l)) return;
                yield{kind: "arbitrary", property: n, value: l, modifier: u, variants: o, important: i, raw: e}
            }
        }(e, s)))), a = new u((e => {
            let t = function (e, t) {
                let r = function (e, t) {
                    if ("arbitrary" === e.kind) {
                        let r = e.value;
                        return e.modifier && (r = Fe(r, e.modifier, t.theme)), null === r ? [] : [[x(e.property, r)]]
                    }
                    let r = t.utilities.get(e.root) ?? [], n = [], o = r.filter((e => !ot(e)));
                    for (let t of o) {
                ...
                for (let i of r) {
                    let r = at(i);
                    (e.important || t.important) && it(i);
                    let a = {kind: "rule", selector: o, nodes: i};
                    for (let r of e.variants) if (null === nt(a, r, t.variants)) return [];
                    n.push({node: a, propertySort: r})
                }
                return n
            }(e, s);
            try {
            ...
            getClassOrder(e) {
                return function (e, t) {
                    let {astNodes: r, nodeSorting: n} = rt(Array.from(t), e), o = new Map(t.map((e => [e, null]))),
                        i = 0n;
                    for (let e of r) {
            ...
            getVariants() {
                return function (e) {
                    ...
                    for (let [r, n] of e.variants.entries()) {
                        ...
                        let i = "@" !== r, a = e.variants.getCompletions(r);
                        switch (n.kind) {
                            case"static":
            ...
            printCandidate: e => function (e, t) {
                ...
                let n = "";
                if ("static" === t.kind && (n += t.root), "functional" === t.kind && (n += t.root, t.value)) if ("arbitrary" === t.value.kind) {
                    if (null !== t.value) {
                        let e = X(t.value.value),
                            r = e ? t.value.value.slice(4, -1) : t.value.value, [o, i] = e ? ["(", ")"] : ["[", "]"];
                        t.value.dataType ? n += `-${o}${t.value.dataType}:${Z(r)}${i}` : n += `-${o}${Z(r)}${i}`
                    }
                } else "named" === t.value.kind && (n += `-${t.value.value}`);
                return "arbitrary" === t.kind && (n += `[${t.property}:${Z(t.value)}]`), ("arbitrary" === t.kind || "functional" === t.kind) && (n += P(t.modifier)), t.important && (n += "!"), r.push(n), r.join(":")
            }(s, e),
            printVariant: e => q(e),
            getVariantOrder() {
    ...
    function rt(e, t, {onInvalidCandidate: r} = {}) {
        ...
        for (let [e, l] of i) {
            ...
            for (let r of l) {
                ...
                if (0 !== l.length) {
                    i = !0;
                    for (let {node: t, propertySort: i} of l) {
                        let l = 0n;
                        for (let e of r.variants) l |= 1n << BigInt(a.get(e));
                        n.set(t, {properties: i, variants: l, candidate: e}), o.push(t)
                    }
                }
            }
            i || r?.(e)
        ...
        return o.sort(((e, t) => {
            ...
            return (r.properties.order[i] ?? 1 / 0) - (o.properties.order[i] ?? 1 / 0) || o.properties.count - r.properties.count || qe(r.candidate, o.candidate)
        })), {astNodes: o, nodeSorting: n}
    }

    function nt(e, t, r, n = 0) {
        if ("arbitrary" === t.kind) return t.relative && 0 === n ? null : void (e.nodes = [y(t.selector, e.nodes)]);
        let {applyFn: o} = r.get(t.root);
        if ("compound" === t.kind) {
            let i = b("@slot");
            if (null === nt(i, t.variant, r, n + 1) || "not" === t.root && i.nodes.length > 1) return null;
    ...
    function it(e) {
        for (let t of e) "at-root" !== t.kind && ("declaration" === t.kind ? t.important = !0 : ("rule" === t.kind || "at-rule" === t.kind) && it(t.nodes))
    }
    ...
    function lt(e, t) {
        let r = 0, n = y("&", e), o = new Set, i = new u((() => new Set)), a = new u((() => new Set));
        C([n], ((e, {parent: n, path: l}) => {
            if ("at-rule" === e.kind) {
                if ("@keyframes" === e.name) return C(e.nodes, (e => {
                    if ("at-rule" === e.kind && "@apply" === e.name) throw new Error("You cannot use `@apply` inside `@keyframes`.")
                })), 1;
                if ("@utility" === e.name) {
                    let r = e.params.replace(/-\*$/, "");
                    return a.get(r).add(e), void C(e.nodes, (r => {
        ...
        for (let e of o) d(e);
        for (let e of s) "nodes" in e && C(e.nodes, ((e, {replaceWith: r}) => {
            if ("at-rule" !== e.kind || "@apply" !== e.name) return;
            let n = e.params.split(/(\s+)/g), o = {}, i = 0;
            for (let [e, t] of n.entries()) e % 2 == 0 && (o[t] = i), i += t.length;
            {
                let n = rt(Object.keys(o), t, {
                    onInvalidCandidate: e => {
                        if (t.theme.prefix && !e.startsWith(t.theme.prefix)) throw new Error(`Cannot apply unprefixed utility class \`${e}\`. Did you mean \`${t.theme.prefix}:${e}\`?`);
                        if (t.invalidCandidates.has(e)) throw new Error(`Cannot apply utility class \`${e}\` because it has been explicitly disabled: https://tailwindcss.com/docs/detecting-classes-in-source-files#explicitly-excluding-classes`);
                        let r = L(e, ":");
                        if (r.length > 1) {
                            let n = r.pop();
                            if (t.candidatesToCss([n])[0]) {
                                ...
                                if (o.length > 0) {
                                    if (1 === o.length) throw new Error(`Cannot apply utility class \`${e}\` because the ${o.map((e => `\`${e}\``))} variant does not exist.`);
                                    {
                ...
                }), i = e.src, a = n.astNodes.map((e => {
                    let t = n.nodeSorting.get(e)?.candidate, r = t ? o[t] : void 0;
                    if (e = structuredClone(e), !i || !t || void 0 === r) return C([e], (e => {
                        e.src = i
                    })), e;
                    let a = [i[0], i[1], i[2]];
                    return a[1] += 7 + r, a[2] = a[1] + t.length, C([e], (e => {
                        e.src = a
                    })), e
                })), l = [];
                for (let e of a) if ("rule" === e.kind) for (let t of e.nodes) l.push(t); else l.push(e);
                r(l)
            }
        }));
        return r
    ...
    async function ct(e, r, n, o = 0, i = !1) {
        ...
        return C(e, ((e, {replaceWith: s}) => {
            if ("at-rule" === e.kind && ("@import" === e.name || "@reference" === e.name)) {
                ...
                let h = A({}, []);
                return l.push((async () => {
                    if (o > 100) throw new Error(`Exceeded maximum recursion depth while resolving \`${u}\` in \`${r}\`)`);
                    let a = await n(u, r), l = t(a.content, {from: i ? a.path : void 0});
                    await ct(l, a.base, n, o + 1, i), h.nodes = function (e, t, r, n, o) {
                        let i = t;
                        if (null !== r) {
                            let t = b("@layer", r, i);
                            t.src = e.src, i = [t]
        ...
        })), l.length > 0 && await Promise.all(l), a
    }
    ...
    function dt(e, {theme: t}, r) {
        ...
        for (let [r, n] of function (e) {
            ...
            return ht(e, [], ((e, r) => {
                ...
                return Array.isArray(e) && e.every((e => "string" == typeof e)) ? ("fontSize" === r[0] ? (t.push([r, e[0]]), e.length >= 2 && t.push([[...r, "-line-height"], e[1]])) : t.push([r, e.join(", ")]), 1) : void 0
            })), t
        }(t)) {
        ...
        if (Object.hasOwn(t, "fontFamily")) {
            let r = 5;
            {
                ...
                n && e.theme.hasDefault("--font-sans") && (e.theme.add("--default-font-family", n, r), e.theme.add("--default-font-feature-settings", ut(t.fontFamily.sans, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-font-variation-settings", ut(t.fontFamily.sans, "fontVariationSettings") ?? "normal", r))
            }
            {
                let n = ut(t.fontFamily.mono);
                n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, r), e.theme.add("--default-mono-font-feature-settings", ut(t.fontFamily.mono, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-mono-font-variation-settings", ut(t.fontFamily.mono, "fontVariationSettings") ?? "normal", r))
            }
        }
        return t
    }
    ...
    function vt(e, t, r, n = []) {
        for (let o of t) if (null != o) for (let t of Reflect.ownKeys(o)) {
            n.push(t);
            let i = r(e[t], o[t], n);
            void 0 !== i ? e[t] = i : gt(e[t]) && gt(o[t]) ? e[t] = vt({}, [e[t], o[t]], r, n) : e[t] = o[t], n.pop()
        }
        return e
    }
    ...
    function wt(e, t, r) {
        return function (n, o) {
            let i = n.lastIndexOf("/"), l = null;
            -1 !== i && (l = n.slice(i + 1).trim(), n = n.slice(0, i).trim());
            let s = (() => {
                let o = mt(n), [i, l] = function (e, t) {
                    if (1 === t.length && t[0].startsWith("--")) return [e.get([t[0]]), e.getOptions(t[0])];
                    let r = pt(t), n = new Map, o = new u((() => new Map)), i = e.namespace(`--${r}`);
                    ...
                    for (let [t, l] of i) {
                        ...
                        c = c.replace(/-([a-z])/g, ((e, t) => t.toUpperCase())), o.get("" === s ? null : s).set(c, [l, e.getOptions(`--${r}${t}`)])
                    }
                    ...
                    return "DEFAULT" === t[t.length - 1] ? [s?.DEFAULT ?? null, c.DEFAULT ?? 0] : "DEFAULT" in s && 1 === Object.keys(s).length ? [s.DEFAULT, c.DEFAULT ?? 0] : (s.__CSS_VALUES__ = c, [s, c])
                }(e.theme, o), s = r(kt(t() ?? {}, o) ?? null);
                if ("string" == typeof s && (s = s.replace("<alpha-value>", "1")), "object" != typeof i) return "object" != typeof l && 4 & l ? s ?? i : i;
                if (null !== s && "object" == typeof s && !Array.isArray(s)) {
                    ...
                    for (let t in i) "__CSS_VALUES__" !== t && (4 & s?.__CSS_VALUES__?.[t] && void 0 !== kt(e, t.split("-")) || (e[a(t)] = i[t]));
                    return e
                }
    ...
    function Ct(e, t, r = null) {
        for (let n = 0; n < e.length; n++) {
            let o = e[n], i = !1, a = 0, l = t(o, {
                parent: r, replaceWith(t) {
                    i || (i = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), a = 0) : 1 === t.length ? (e[n] = t[0], a = 1) : (e.splice(n, 1, ...t), a = t.length) : (e[n] = t, a = 1))
                }
            }) ?? 0;
            if (i) 0 === l ? n-- : n += a - 1; else {
                if (2 === l) return 2;
        ...
        for (let a = 0; a < e.length; a++) {
            ...
            switch (l) {
                ...
                case 126: {
                    ...
                    let n = a, l = a + 1;
                    for (; l < e.length && (t = e.charCodeAt(l), 44 === t || 62 === t || 10 === t || 32 === t || 43 === t || 9 === t || 126 === t); l++) ;
                    a = l - 1;
                    let s = e.slice(n, l), c = "," === s.trim() ? At(s) : yt(s);
                    o ? o.nodes.push(c) : r.push(c);
                    break
                }
                case 40: {
                    let l = xt(i, []);
                    if (i = "", ":not" !== l.value && ":where" !== l.value && ":has" !== l.value && ":is" !== l.value) {
                        let n = a + 1, s = 0;
                        for (let r = a + 1; r < e.length; r++) if (t = e.charCodeAt(r), 40 !== t) {
                            if (41 === t) {
                                if (0 === s) {
                                    a = r;
                                    break
                ...
                case 91: {
                    ...
                    i = "";
                    let n = a, l = 0;
                    for (let r = a + 1; r < e.length; r++) if (t = e.charCodeAt(r), 91 !== t) {
                        if (93 === t) {
                            if (0 === l) {
                                a = r;
                                break
    ...
    function Kt({designSystem: e, ast: t, resolvedConfig: r, featuresRef: n, referenceMode: o}) {
        let i = {
            addBase(r) {
                if (o) return;
                let i = Et(r);
                n.current |= Re(i, e), t.push(b("@layer", "base", i))
            }, addVariant(t, r) {
                if (!Ye.test(t)) throw new Error(`\`addVariant('${t}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                if ("string" == typeof r) {
                ...
                }), {compounds: Je("string" == typeof r ? [r] : r)}) : "object" == typeof r && e.variants.fromAst(t, Et(r))
            }, matchVariant(t, r, n) {
                function o(e, t, n) {
                ...
                e.variants.group((() => {
                    ...
                    return s = -1 === s ? i.length : s, c = -1 === c ? i.length : c, s !== c ? s - c : a < l ? -1 : 1
                }))
            }, addUtilities(r) {
                let i = (r = Array.isArray(r) ? r : [r]).flatMap((e => Object.entries(e)));
                i = i.flatMap((([e, t]) => L(e, ",").map((e => [e.trim(), t]))));
                let a = new u((() => []));
                for (let [e, r] of i) {
                    ...
                    if (Ct(n, (e => {
                        if ("selector" === e.kind && "." === e.value[0] && St.test(e.value.slice(1))) {
                            let t = e.value;
                            e.value = "&";
                            let o = jt(n), l = t.slice(1), s = "&" === o ? Et(r) : [y(o, Et(r))];
                            return a.get(l).push(...s), i = !0, void (e.value = t)
                        }
                ...
                for (let [t, r] of a) e.theme.prefix && C(r, (t => {
                    if ("rule" === t.kind) {
                        let r = Tt(t.selector);
                        Ct(r, (t => {
                ...
                for (let [i, a] of Object.entries(t)) {
                    let t = function ({negative: t}) {
                        return l => {
                            if ("arbitrary" === l.value?.kind && o.length > 0 && !o.includes("any") && (l.value.dataType && !o.includes(l.value.dataType) || !l.value.dataType && !ie(l.value.value, o))) return;
                            let s, c = o.includes("color"), u = null, d = !1;
                            {
                                ...
                                }, e)), l.value ? "arbitrary" === l.value.kind ? u = l.value.value : l.value.fraction && e[l.value.fraction] ? (u = e[l.value.fraction], d = !0) : e[l.value.value] ? u = e[l.value.value] : e.__BARE_VALUE__ && (u = e.__BARE_VALUE__(l.value) ?? null, d = (null !== l.value.fraction && u?.includes("/")) ?? !1) : u = e.DEFAULT ?? null
                            }
                            if (null === u) return;
                            {
                    ...
                    if (!St.test(i)) throw new Error(`\`matchUtilities({ '${i}' : … })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
            ...
            }, theme: wt(e, (() => r.theme ?? {}), (e => e)), prefix: e => e, config(e, t) {
                let n = r;
                if (!e) return n;
                let o = mt(e);
    ...
    function Et(e) {
        ...
        for (let [e, n] of r) if ("object" != typeof n) {
            ...
            t.push(x(e, String(n)))
        } else if (Array.isArray(n)) for (let r of n) "string" == typeof r ? t.push(x(e, r)) : t.push(y(e, Et(r))); else null !== n && t.push(y(e, Et(n)));
        return t
    }
    ...
    function Ot(e, t, r) {
        for (let r of function (e) {
            let t = [];
            if ("keyframes" in e.theme) for (let [r, n] of Object.entries(e.theme.keyframes)) t.push(b("@keyframes", r, Et(n)));
            return t
    ...
    var Ut = Wt((e => {
        ...
        hueRotate: {0: "0deg", 15: "15deg", 30: "30deg", 60: "60deg", 90: "90deg", 180: "180deg", ...Bt},
        inset: ({theme: e}) => ({
            auto: "auto",
            "1/2": "50%",
            "1/3": "33.333333%",
        ...
        textUnderlineOffset: {auto: "auto", 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ..._t},
        transformOrigin: {
            center: "center",
            top: "top",
            "top-right": "top right",
    ...
    function Ht(e, t) {
        ...
        let n = function (e) {
            let t = new Set, r = wt(e.design, (() => e.theme), o), n = Object.assign(r, {theme: r, colors: Ft});
    ...
    function Yt(e, {config: t, base: r, path: n, reference: o}) {
        let i = [];
        ...
        for (let i of t.presets ?? []) Yt(e, {path: n, base: r, config: i, reference: o});
        for (let t of i) e.plugins.push(t), t.config && Yt(e, {
            path: n,
            base: r,
            config: t.config,
            reference: !!t.reference
        });
        let a = t.content ?? [], l = Array.isArray(a) ? a : a.files;
        for (let t of l) e.content.files.push("object" == typeof t ? t : {base: r, pattern: t});
        e.configs.push(t)
    }
    ...
    function Gt(e, t) {
        ...
        let n = function ({center: e, padding: t, screens: r}, n) {
            let o = [], i = null;
            if (e && o.push(x("margin-inline", "auto")), ("string" == typeof t || "object" == typeof t && null !== t && "DEFAULT" in t) && o.push(x("padding-inline", "string" == typeof t ? t : t.DEFAULT)), "object" == typeof r && null !== r) {
                i = new Map;
            ...
            if ("object" == typeof t && null !== t) {
                ...
                for (let [t, , r] of e) if (i && i.has(t)) i.get(t).nodes.push(x("padding-inline", r)); else {
                    if (i) continue;
    ...
    async function er({designSystem: e, base: t, ast: r, loadModule: n, sources: o}) {
        ...
        C(r, ((e, {parent: t, replaceWith: r, context: n}) => {
                ...
                if ("@plugin" === e.name) {
                    ...
                    for (let t of e.nodes ?? []) {
                        ...
                        let e = L(t.value, ",").map((e => {
                            ...
                            if ("{" === e[0] && "}" === e[e.length - 1]) throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${S([t]).trim()}\` is not supported.\n\nUsing an object as a plugin option is currently only supported in JavaScript configuration files.`);
                            return e
                        }));
                    ...
                    }, Object.keys(l).length > 0 ? l : null]), r([]), void (i |= 4)
                }
                if ("@config" === e.name) {
            ...
            for (let [t, r] of [["t", "top"], ["tr", "top right"], ["r", "right"], ["br", "bottom right"], ["b", "bottom"], ["bl", "bottom left"], ["l", "left"], ["tl", "top left"]]) e.utilities.static(`bg-gradient-to-${t}`, (() => [x("--tw-gradient-position", `to ${r} in oklab`), x("background-image", "linear-gradient(var(--tw-gradient-stops))")]));
            e.utilities.static("bg-left-top", (() => [x("background-position", "left top")])), e.utilities.static("bg-right-top", (() => [x("background-position", "right top")])), e.utilities.static("bg-left-bottom", (() => [x("background-position", "left bottom")])), e.utilities.static("bg-right-bottom", (() => [x("background-position", "right bottom")])), e.utilities.static("object-left-top", (() => [x("object-position", "left top")])), e.utilities.static("object-right-top", (() => [x("object-position", "right top")])), e.utilities.static("object-left-bottom", (() => [x("object-position", "left bottom")])), e.utilities.static("object-right-bottom", (() => [x("object-position", "right bottom")])), e.utilities.functional("max-w-screen", (t => {
                if (!t.value || "arbitrary" === t.value.kind) return;
                let r = e.theme.resolve(t.value.value, ["--breakpoint"]);
                return r ? [x("max-width", r)] : void 0
            })), e.utilities.static("overflow-ellipsis", (() => [x("text-overflow", "ellipsis")])), e.utilities.static("decoration-slice", (() => [x("-webkit-box-decoration-break", "slice"), x("box-decoration-break", "slice")])), e.utilities.static("decoration-clone", (() => [x("-webkit-box-decoration-break", "clone"), x("box-decoration-break", "clone")])), e.utilities.functional("flex-shrink", (e => {
                if (!e.modifier) {
        ...
        }, !a.length && !l.length) return 0;
        let [c, u] = await Promise.all([Promise.all(l.map((async ({id: e, base: t, reference: r}) => {
            let o = await n(e, t, "config");
            return {path: e, base: o.base, config: o.module, reference: r}
        }))), Promise.all(a.map((async ([{id: e, base: t, reference: r}, o]) => {
            let i = await n(e, t, "plugin");
            return {path: e, base: i.base, plugin: i.module, options: o, reference: r}
        })))]);
        return i |= tr({designSystem: e, base: t, ast: r, sources: o, configs: c, pluginDetails: u}), i
    }
    ...
    function tr({designSystem: e, base: t, ast: r, sources: n, configs: o, pluginDetails: i}) {
        ...
        })), ...o], {resolvedConfig: s} = Ht(e, [{
            config: Pt(e.theme),
            base: t,
            reference: !0
        }, ...l, {config: {plugins: [Jt]}, base: t, reference: !0}]), {
            resolvedConfig: c,
            replacedThemeKeys: u
        } = Ht(e, l), d = e.resolveThemeValue;
        ...
        for (let {handler: e, reference: t} of s.plugins) t ? (f ||= Kt({...p, referenceMode: !0}), e(f)) : e(h);
        if (dt(e, c, u), Ot(e, c), function (e, t) {
            ...
            for (let [e, i] of Object.entries(r)) {
                ...
                }, a = t.variants.get(e), l = t.theme.resolveValue(e, ["--breakpoint"]);
    ...
    function rr({ast: e}) {
        let t = new u((e => function (e) {
            ...
            }(e.code))), r = new u((e => ({url: e.file, content: e.code, ignore: !1}))),
            n = {file: null, sources: [], mappings: []};
        C(e, (e => {
            if (!e.src || !e.dst) return;
            let o = r.get(e.src[0]);
            if (!o.content) return;
            let i = t.get(e.src[0]), a = t.get(e.dst[0]), l = o.content.slice(e.src[1], e.src[2]), s = 0;
            for (let t of l.split("\n")) {
                if ("" !== t.trim()) {
                    let t = i.find(e.src[1] + s), r = a.find(e.dst[1]);
                    n.mappings.push({name: null, originalPosition: {source: o, ...t}, generatedPosition: r})
                }
                s += t.length, s += 1
            }
            let c = i.find(e.src[2]), u = a.find(e.dst[2]);
            n.mappings.push({name: null, originalPosition: {source: o, ...c}, generatedPosition: u})
        }));
        for (let e of t.keys()) n.sources.push(r.get(e));
        return n.mappings.sort(((e, t) => e.generatedPosition.line - t.generatedPosition.line || e.generatedPosition.column - t.generatedPosition.column || (e.originalPosition?.line ?? 0) - (t.originalPosition?.line ?? 0) || (e.originalPosition?.column ?? 0) - (t.originalPosition?.column ?? 0))), n
    }
    ...
    function or(e) {
        let t = e.indexOf("{");
        if (-1 === t) return [e];
        let r = [], n = e.slice(0, t), o = e.slice(t), i = 0, a = o.lastIndexOf("}");
        for (let e = 0; e < o.length; e++) {
            let t = o[e];
            if ("{" === t) i++; else if ("}" === t && (i--, 0 === i)) {
                a = e;
                break
            }
        }
        ...
        l = function (e) {
            ...
            let t = e.match(nr);
            if (!t) return [e];
            let [, r, n, o] = t, i = o ? parseInt(o, 10) : void 0, a = [];
            if (/^-?\d+$/.test(r) && /^-?\d+$/.test(n)) {
                let e = parseInt(r, 10), t = parseInt(n, 10);
                if (void 0 === i && (i = e <= t ? 1 : -1), 0 === i) throw new Error("Step cannot be zero in sequence expansion.");
                let o = e < t;
                o && i < 0 && (i = -i), !o && i > 0 && (i = -i);
                for (let r = e; o ? r <= t : r >= t; r += i) a.push(r.toString())
            }
            return a
        }(s) : L(s, ","), l = l.flatMap((e => or(e)));
        let u = or(c);
    ...
    async function sr(e, {base: t = "", from: r, loadModule: n = ar, loadStylesheet: o = lr} = {}) {
        ...
        let s = null, u = new c, d = [], f = [], p = null, v = null, w = [], $ = [], j = [], T = [], K = null;
        C(e, ((e, {parent: t, replaceWith: r, context: n}) => {
            if ("at-rule" === e.kind) {
                        ...
                        return Se.test(t) ? r => {
                            ...
                            C(e.nodes, (e => {
                                ...
                                h(t, (e => {
                                    ...
                                    if (!("--spacing" !== e.value || n["--modifier"].usedSpacingNumber && n["--value"].usedSpacingNumber)) return h(e.nodes, (e => {
                                        if ("function" !== e.kind || "--value" !== e.value && "--modifier" !== e.value) return;
                                        let t = e.value;
                                        for (let r of e.nodes) if ("word" === r.kind) if ("integer" === r.value) n[t].usedSpacingInteger ||= !0; else if ("number" === r.value && (n[t].usedSpacingNumber ||= !0, n["--modifier"].usedSpacingNumber && n["--value"].usedSpacingNumber)) return 2
                                    })), 0;
                                ...
                                if (null === o) return;
                                let a = !1, l = !1, s = !1, c = !1, u = new Map, d = !1;
                                    ...
                                    0 === (h(f, ((f, {replaceWith: p}) => {
                                        if ("function" === f.kind) {
                                            if ("--value" === f.value) {
                                                a = !0;
                                                let i = _e(o, f, r);
                                                return i ? (l = !0, i.ratio ? d = !0 : u.set(e, t), p(i.nodes), 1) : (a ||= !1, n([]), 2)
                                            }
                                            if ("--modifier" === f.value) {
                                ...
                                for (let [o, {
                                    ...
                                    themeKeys: s
                                }] of [[e, n["--value"]], [t, n["--modifier"]]]) {
                                    for (let e of i) o.push(e);
                                    if (a) o.push(...Ke); else if (l) for (let e of Ke) be(e) && o.push(e);
                                    for (let e of r.theme.keysInNamespaces(s)) o.push(e.replace(Ue, ((e, t, r) => `${t}.${r}`)))
                                }
                ...
                if ("@source" === e.name) {
                    ...
                    let o = !1, i = !1, a = e.params;
                    if ("n" === a[0] && a.startsWith("not ") && (o = !0, a = a.slice(4)), "i" === a[0] && a.startsWith("inline(") && (i = !0, a = a.slice(7, -1)), '"' === a[0] && '"' !== a[a.length - 1] || "'" === a[0] && "'" !== a[a.length - 1] || "'" !== a[0] && '"' !== a[0]) throw new Error("`@source` paths must be quoted.");
                    let l = a.slice(1, -1);
                    if (i) {
                        let e = o ? T : j, t = L(l, " ");
                ...
                })), "@variant" === e.name && w.push(e)) : w.push(e)), "@custom-variant" === e.name) {
                    if (null !== t) throw new Error("`@custom-variant` cannot be nested.");
                    r([]);
                    let [n, o] = L(e.params, " ");
                    if (!Ye.test(n)) throw new Error(`\`@custom-variant ${n}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                ...
                if ("@media" === e.name) {
                    ...
                    for (let r of t) if (r.startsWith("source(")) {
                        ...
                        C(e.nodes, ((e, {replaceWith: r}) => {
                            if ("at-rule" === e.kind && "@tailwind" === e.name && "utilities" === e.params) return e.params += ` source(${t})`, r([A({sourceBase: n.base}, [e])]), 2
                        }))
                    ...
                    } else "important" === r ? s = !0 : "reference" === r ? e.nodes = [A({reference: !0}, e.nodes)] : o.push(r);
                    o.length > 0 ? e.params = o.join(" ") : t.length > 0 && r(e.nodes)
                }
                if ("@theme" === e.name) {
                    let [t, o] = function (e) {
                        let t = 0, r = null;
                        for (let n of L(e, " ")) "reference" === n ? t |= 2 : "inline" === n ? t |= 1 : "default" === n ? t |= 4 : "static" === n ? t |= 8 : n.startsWith("prefix(") && n.endsWith(")") && (r = n.slice(7, -1));
                        return [t, r]
                    }(e.params);
                    if (n.reference && (t |= 2), o) {
                        if (!ir.test(o)) throw new Error(`The prefix "${o}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                        u.prefix = o
                    }
                    return C(e.nodes, (r => {
                        if ("at-rule" === r.kind && "@keyframes" === r.name) return u.addKeyframes(r), 1;
                        if ("comment" === r.kind) return;
                        if ("declaration" === r.kind && r.property.startsWith("--")) return void u.add(a(r.property), r.value ?? "", t, r.src);
                        let n = S([b(e.name, e.params, [r])]).split("\n").map(((e, t, r) => `${0 === t || t >= r.length - 2 ? " " : ">"} ${e}`)).join("\n");
                        throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.\n\n${n}`)
                    })), p ? r([]) : (p = k(":root, :host", []), p.src = e.src, r([p])), 1
                }
            }
        }));
        let E = et(u);
        ...
        if (w.length > 0) {
            for (let e of w) {
                let t = k("&", e.nodes), r = e.params, n = E.parseVariant(r);
                if (null === n) throw new Error(`Cannot use \`@variant\` with unknown variant: ${r}`);
                if (null === nt(t, n, E.variants)) throw new Error(`Cannot use \`@variant\` with variant: ${r}`);
                Object.assign(e, t)
            }
            l |= 32
        }
        ...
        })), {designSystem: E, ast: e, sources: $, root: K, utilitiesNode: v, features: l, inlineCandidates: j}
    }

    async function cr(e, r = {}) {
        let n = t(e, {from: r.from}), o = await async function (e, t = {}) {
            let {
                designSystem: r,
                ast: n,
                sources: o,
            ...
            n.unshift($("! tailwindcss v4.1.11 | MIT License | https://tailwindcss.com "));
            let u = new Set, d = null, f = 0, p = !1;
            for (let e of s) r.invalidCandidates.has(e) || (u.add(e), p = !0);
            return {
                sources: o, root: i, features: l, build(o) {
                    if (0 === l) return e;
                    if (!a) return d ??= T(n, r, t.polyfills), d;
                    let i = p, s = !1;
                    p = !1;
                    let h = u.size;
                    for (let e of o) if (!r.invalidCandidates.has(e)) if ("-" === e[0] && "-" === e[1]) {
                    ...
                    return t.from && C(m, (e => {
                        e.src ??= a.src
                    })), s || f !== m.length ? (f = m.length, a.nodes = m, d = T(n, r, t.polyfills), d) : (d ??= T(n, r, t.polyfills), d)
                }
            }
        }(n, r), i = n, a = e;
        return {
    ...
    var dr, fr = "text/tailwindcss", pr = new Set, hr = "", mr = document.createElement("style"),
        gr = Promise.resolve(), vr = 1, wr = new class {
            start(e) {
    ...
    function yr(e) {
        gr = gr.then((async function () {
            if (!dr && "full" !== e) return;
            let t = vr++;
            wr.start(`Build #${t} (${e})`), "full" === e && await async function () {
                wr.start("Create compiler"), wr.start("Reading Stylesheets");
                let e = document.querySelectorAll(`style[type="${fr}"]`), t = "";
                for (let r of e) $r(r), t += r.textContent + "\n";
                if (t.includes("@import") || (t = `@import "tailwindcss";${t}`), wr.end("Reading Stylesheets", {
                    size: t.length,
                    changed: hr !== t
                }), hr !== t) {
            ...
            }(), wr.start("Build"), await async function (e) {
                if (!dr) return;
                let t = new Set;
                wr.start("Collect classes");
                for (let e of document.querySelectorAll("[class]")) for (let r of e.classList) pr.has(r) || (pr.add(r), t.add(r));
                wr.end("Collect classes", {count: t.size}), (0 !== t.size || "incremental" !== e) && (wr.start("Build utilities"), mr.textContent = dr.build(Array.from(t)), wr.end("Build utilities"))
            }(e), wr.end("Build"), wr.end(`Build #${t} (${e})`)
        })).catch((e => wr.error(e)))
    }
    ...
    function $r(e) {
        xr.observe(e, {attributes: !0, attributeFilter: ["type"], characterData: !0, subtree: !0, childList: !0})
    }

    new MutationObserver((e => {
        let t = 0, r = 0;
        for (let n of e) {
            for (let e of n.addedNodes) e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === fr && ($r(e), t++);
        ...
        childList: !0,
        subtree: !0
    }), yr("full"), document.head.append(mr)
})();
